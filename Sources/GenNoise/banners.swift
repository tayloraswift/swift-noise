...
func banner_classic3d(width: Int, height: Int, seed: Int) {
    color_noise_png(
        r_noise: ClassicNoise3D(amplitude: 1.6 * 0.5*255, frequency: 0.01, seed: seed),
...
func banner_supersimplex2d(width: Int, height: Int, seed: Int) {
    color_noise_png(
        r_noise: GradientNoise2D(amplitude: 0.5*255, frequency: 0.01, seed: seed),
...
func banner_supersimplex3d(width: Int, height: Int, seed: Int) {
    color_noise_png(
        r_noise: GradientNoise3D(amplitude: 0.5*255, frequency: 0.01, seed: seed),
...
func banner_cell2d(width: Int, height: Int, seed: Int) {
    color_noise_png(
        r_noise: CellNoise2D(amplitude: 3*255, frequency: 0.03, seed: seed),
...
func banner_cell3d(width: Int, height: Int, seed: Int) {
    color_noise_png(
        r_noise: CellNoise3D(amplitude: 3*255, frequency: 0.03, seed: seed),
...
func banner_FBM(width: Int, height: Int, seed: Int) {
    color_noise_png(
        r_noise: FBM<CellNoise3D>    (
            CellNoise3D(amplitude: 10*255, frequency: 0.01, seed: seed + 2),
            octaves: 7,
            persistence: 0.75
        ),
        g_noise: FBM<GradientNoise3D>(
            GradientNoise3D(amplitude: 300, frequency: 0.005, seed: seed + 3),
            octaves: 7,
            persistence: 0.75
        ),
        b_noise: FBM<GradientNoise2D>(
            GradientNoise2D(amplitude: 300, frequency: 0.005),
            octaves: 7,
            persistence: 0.75
        ),
        width: width,
...
func banner_disk2d(width: Int, height: Int, seed: Int) {
    ...
    _dots(
        poisson.generate(radius: 35, width: width, height: height, k: 80, seed: (10, 10)),
        color: (0, 210, 70)
    )
    _dots(
        poisson.generate(radius: 25, width: width, height: height, k: 80, seed: (45, 15)),
        color: (0, 10, 235)
    )
    _dots(
        poisson.generate(radius: 30, width: width, height: height, k: 80, seed: (15, 45)),
        color: (225, 20, 0)
    )
...
func banner_voronoi2d(width: Int, height: Int, seed: Int) {
    ...
    let rgba: [PNG.RGBA<UInt8>]  = domain.map {
        ...
        @inline(__always) func _supersample(_ x: Double, _ y: Double) -> (
            r: UInt8,
            g: UInt8,
            b: UInt8
        ) {
            ...
            return (
                .init(.init(r) * saturate),
                .init(.init(g) * saturate),
                .init(.init(b) * saturate)
            )
        }
        ...
        g: Int = 0,
        b: Int = 0
        let supersamples: [(Double, Double)] = [
            (0, 0), (0, 0.4), (0.4, 0), (-0.4, 0), (0, -0.4),
...
public func banners(width: Int, ratio: Double) {
