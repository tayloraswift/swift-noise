...
public func calibrate_noise(width: Int, height: Int, seed: Int = 0) {
    print("calibrate-classic-distortion")
    grayscale_noise_png(
        noise: DistortedNoise(
            FBM(ClassicNoise3D(amplitude: 0.5*255, frequency: 2, seed: seed), octaves: 4),
            strength: 0.003
        ),
        width: width,
        height: height,
    ...
    grayscale_noise_png(
        noise: GradientNoise2D(amplitude: 0.5*255, frequency: 4, seed: seed),
        width: width,
        height: height,
        value_offset: 0.5*255,
    ...
    grayscale_noise_png(
        noise: GradientNoise3D(amplitude: 0.5*255, frequency: 4, seed: seed),
        width: width,
        height: height,
        value_offset: 0.5*255,
    ...
    grayscale_noise_png(
        noise: CellNoise2D(amplitude: 255, frequency: 4, seed: seed),
        width: width,
        height: height,
        value_offset: 0,
    ...
    grayscale_noise_png(
        noise: CellNoise3D(amplitude: 255, frequency: 4, seed: seed),
        width: width,
        height: height,
        value_offset: 0,
